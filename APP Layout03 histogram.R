...
server <- function(input, output) {
  ...
  output$map <- renderLeaflet({
    ...
    # putting count data to spatial data
    ...
    if (input$variable == "Age") {
      ...
      mytext <- paste(
        ...
        "Medal Count: ", world_spdf@data$Age, 
        sep="") %>%
      ...
      mytext <- paste(
        "<b>", world_spdf@data$NAME,"</b><br/>", 
        "Avg Age: ", world_spdf@data$Age, "<br/>", 
        "Avg Height: ", world_spdf@data$Age, "<br/>", 
        "Avg Weight: ", world_spdf@data$Age, "<br/>", 
        "Avg BMI: ", world_spdf@data$Age, 
        sep="") %>%
        lapply(htmltools::HTML)
      ...
      mytext <- paste(
        ...
        "Avg Weight: ", world_spdf@data$Weight, 
        sep="") %>%
        lapply(htmltools::HTML)
